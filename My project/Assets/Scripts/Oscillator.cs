...
public class Oscillator : MonoBehaviour
{
    ...
    [SerializeField] private float frequency = 1f; // frequency of the oscillation
    [SerializeField] private float speedChangeRate = 1f; // rate at which the oscillation speed changes
    [SerializeField] private Vector3 axis = Vector3.left; // axis along which the object oscillates
